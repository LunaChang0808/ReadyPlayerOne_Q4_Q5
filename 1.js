export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["capstan.gif",new URL("./files/capstan",import.meta.url)]]);
...
<div style="max-width: 500px; margin: 30px 0; padding: 15px 30px; background-color: #ffffee; font: 700 18px/24px sans-serif</div>
